...
public class MoviesController : Controller
{
    ...
    public MoviesController(IMovieRepository repo) // Dependency Injection, object van een klasse injecteren die aan de voorwaarden van IMovieRepository voldoet
    {
        _repo = repo;
    }
    // GET: /Movies
    public IActionResult Index(string? search, string? genre, string? sort) // Added sorting
    {
