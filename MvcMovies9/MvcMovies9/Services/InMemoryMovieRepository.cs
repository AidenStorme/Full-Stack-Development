...
public class InMemoryMovieRepository : IMovieRepository // Dit is een overerving van IMovieRepository, dus moet minimum die methodes bevatten van IMovieRepository
{
